...
# RUN THIS FILE
import pygame
from sudoku import solve, valid, generate_board
import time
pygame.font.init()
    ...
    def draw(self, win):
        ...
        for i in range(self.rows+1):
            ...
            pygame.draw.line(win, (0, 0, 0), (0, i*gap), (self.width, i*gap),
                             thick)
            pygame.draw.line(win, (0, 0, 0), (i * gap, 0), (i * gap,
                                                            self.height), thick)
...
def redraw_window(win, board, time_len, strikes):
    win.fill((255, 255, 255))
    # Draw time
    fnt = pygame.font.SysFont("comicsans", 40)
    text = fnt.render("Time: " + format_time(time_len), 1, (0, 0, 0))
